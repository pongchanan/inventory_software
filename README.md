...
- [Backend Setup Guide](backend/SETUP_GUIDE.md) — Step-by-step setup and troubleshooting
- [Backend API Docs](backend/API_DOCUMENTATION.md) — Full endpoint reference
